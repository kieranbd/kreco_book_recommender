...
```{r head of book_ratings, eval=F, message=F, echo=F}
temp <- head(book_ratings); temp
```
...
```{r matrixify example, eval=F, message=F, echo=T}
...
```{r ub existing, eval=F, message=F, echo=T, results="hide", warning=FALSE}
...
```{r show recommendations ub, eval=F, message=F, echo=T, warning=FALSE}
recommendations_ub
```
...
```{r generate recs ib new, eval=F, message=F, echo=T, results="hide", warning=FALSE}
...
```{r show recommendations ib, eval=F, message=F, echo=T, warning=FALSE}
recommendations_ib
```
...
```{r mfrec existing, eval=F, message=F, echo=T, results="hide", warning=FALSE}
# user exists, so we set new_user = FALSE, and leave new_user_df out completely
...
```{r show recommendations mfrec, eval=F, message=F, echo=T, warning=FALSE}
